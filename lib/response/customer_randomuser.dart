class ModelCustomrResponse {
  List<ModelCustomrRequest>? results;
  Info? info;

  ModelCustomrResponse({this.results, this.info});

  ModelCustomrResponse.fromJson(Map<String, dynamic> json) {
    if (json['results'] != null) {
      results = <ModelCustomrRequest>[];
      json['results'].forEach((v) {
        results!.add(new ModelCustomrRequest.fromJson(v));
      });
    }
...
class ModelCustomrRequest {
  ...
  ModelCustomrRequest.fromJson(Map<String, dynamic> json) {
    gender = json['gender'];
