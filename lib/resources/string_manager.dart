...
class StringManager{
  ...
  static const String homecontent="inside the Homescreen";
   ...
   static const String categoriescontent="inside the categories screen";
   static const String morecontent="inside the More screen";
   static const String listcontent="inside the  List screen";
   ...
   static const String  passwordrequried="password  is requried";
   static const String  userrequried="username is requried";
   static const String  confirmpasswordrequried="confirm password is requried";
   static const String  emailvalid="please enter vaild email";
   static const String  passwordlvalid="please enter vaild password";
   static const String  uservalid="Username must be at least 4 characters in length";
   static const String  confirmpasswordvalid="Password Does Not Match";
  
  
  //hinttext
  static const String usernamelhintext="Enter Your Name";
  static const String emaillhintext="Email";
